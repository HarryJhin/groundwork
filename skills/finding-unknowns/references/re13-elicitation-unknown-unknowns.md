...
이 논문이 unknown unknown을 "가장 어려운 질문"으로 두고 마지막에 다룬다.
저자도 사용자도 무엇이 빠졌는지 식별하지 못하는 상태라 도출 기법 대부분이 겨냥하지 못한다.
...
스펙에 이 행을 위한 절은 따로 두지 않고 노출로 드러난 것이 있으면 설계에서 그것을 쓰는 곳에 근거와 함께 들어간다.
